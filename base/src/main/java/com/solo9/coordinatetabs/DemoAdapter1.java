...
class DemoAdapter1 extends RecyclerView.Adapter {
    ...
    DemoAdapter1(List<DemoItem> demoItems, Context context) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        Picasso.get().load(R.mipmap.placeholder).into(demoItemHolder.addressIcon);
        Picasso.get().load(R.mipmap.smartphone).into(demoItemHolder.phoneIcon);
        Picasso.get().load(R.mipmap.linkedin).into(demoItemHolder.linkedinIcon);
               Picasso.get().load(R.mipmap.github).into(demoItemHolder.githubIcon);
        Picasso.get().load(R.mipmap.stackoverflow).into(demoItemHolder.stackOverFlowIcon);



        Picasso.get().load(R.mipmap.copy).into(demoItemHolder.emailLinkCopy);
        Picasso.get().load(R.mipmap.copy).into(demoItemHolder.addressLinkCopy);
        Picasso.get().load(R.mipmap.copy).into(demoItemHolder.phoneLinkCopy);
        Picasso.get().load(R.mipmap.copy).into(demoItemHolder.linkedinLinkCopy);

        Picasso.get().load(R.mipmap.copy).into(demoItemHolder.githubLinkCopy);
        Picasso.get().load(R.mipmap.copy).into(demoItemHolder.stackoverflowLinkCopy);



        Picasso.get().load(R.mipmap.openlink).into(demoItemHolder.email);

        Picasso.get().load(R.mipmap.phone).into(demoItemHolder.phone);
        Picasso.get().load(R.mipmap.openlink).into(demoItemHolder.linkedin);
        Picasso.get().load(R.mipmap.openlink).into(demoItemHolder.github);
        Picasso.get().load(R.mipmap.openlink).into(demoItemHolder.stackOverFlow);
    ...
    public class DemoItemHolder1 extends RecyclerView.ViewHolder {
        ImageView email,address,phone,linkedin,twitter,github,stackOverFlow;
